...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:ns_t3dev/Resources/Private/Language/locallang_db.xlf:tx_nst3dev_domain_model_productarea',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_nst3dev_domain_model_productarea',
                'foreign_table_where' => 'AND {#tx_nst3dev_domain_model_productarea}.{#pid}=###CURRENT_PID### AND {#tx_nst3dev_domain_model_productarea}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'name' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ns_t3dev/Resources/Private/Language/locallang_db.xlf:tx_nst3dev_domain_model_productarea.name',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'description' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ns_t3dev/Resources/Private/Language/locallang_db.xlf:tx_nst3dev_domain_model_productarea.description',
            'config' => [
                'type' => 'text',
                'enableRichtext' => true,
        ...
        'slug' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ns_t3dev/Resources/Private/Language/locallang_db.xlf:tx_nst3dev_domain_model_productarea.slug',
            'config' => [
                'type' => 'slug',
                'size' => 50,
                'generatorOptions' => [
